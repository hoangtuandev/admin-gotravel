...
function RemoveAdvertisement(props) {
    ...
    const handleSubmitRemoveAdvertisement = () => {
        setOnLoading(true);
        api.removeAdvertisement(advertisement).then((res) => {
            api.getActiveAdvertisement().then((res) => {
                setAdvertisementList(res.data);
                setOnLoading(false);
                dispatch(handleToggleRemoveAdvertisement(false));
            });
        });
    };
    ...
    return (
        <Dialog
            open={openRemove}
            onClose={() => dispatch(handleToggleRemoveAdvertisement(false))}
            className={cx('dialog')}
            ...
            <DialogActions className={cx('dialog-actions')}>
                ...
                {!onLoading && (
                    <Button
                        ...
                        onClick={() => handleSubmitRemoveAdvertisement()}
                    >
                        GỠ
                    </Button>
                )}
...
export default RemoveAdvertisement;
